...
def write_rom(game: Game, romWriter: Optional[RomWriter] = None) -> str:
    ...
    rom_name = f"Blue{game.seed}.sfc"
    rom1_path = f"roms/{rom_name}"
    rom_clean_path = "roms/BluePlague.sfc"
    ...
    # Early yellow doors fix
    romWriter.writeBytes(0x7ec49, b"\x46")
    romWriter.writeBytes(0x7ec55, b"\x46")
